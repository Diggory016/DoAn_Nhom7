...
$cate = new Category;
$getAllCates = $cate->getAllCates();
$provider = new Provider;
$getAllProviders = $provider->getAllProviders();
$user = new User();
...
<html lang="en">
    ...
    <body>
        ...
        <div id="header" style="background-color: black;">
            <h1><a href="index.php">
                <img width="75%" src="./images/logoadmin.png" alt="">
            </a></h1>
        </div>
        <!--close-Header-part-->
        <!--top-Header-menu-->
        <div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav">
                ...
                <li class=""><a title="" href="logout.php"><i class="icon
